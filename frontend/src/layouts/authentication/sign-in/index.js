      ...
      >
        ...
        >
          ...
          >
            ...
            <MDBox width="100%">
              ...
              <MDTypography variant="button" fontWeight="regular" color="white" opacity={0.8}>
                Connectez-vous pour accéder à votre espace de gestion de stock.
              </MDTypography>
          ...
          <Grid item xs={12} md={7} sx={{ backgroundColor: "white" }}>
            <MDBox p={{ xs: 4, md: 6 }} height="100%" display="flex" flexDirection="column" justifyContent="center">
              <MDBox mb={4}>
                ...
                <MDTypography variant="h2" fontWeight="bold" color="dark" mb={0.5}>
                  Connexion
                </MDTypography>
              ...
              <MDBox component="form" role="form" onSubmit={handleLogin}>
                ...
                <MDBox mb={2.5}>
                  <MDBox display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                    <MDTypography variant="caption" fontWeight="bold" color="dark" textTransform="uppercase">
                      Mot de passe
                    </MDTypography>
                    <MDTypography component={Link} to="/authentication/forgot-password" variant="caption" fontWeight="bold" sx={{ color: "#b02a46" }}>
                      Mot de passe oublié ?
                    </MDTypography>
                  </MDBox>
                  <MDInput
